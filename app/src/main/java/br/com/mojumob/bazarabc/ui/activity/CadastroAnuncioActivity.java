...
public class CadastroAnuncioActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void carregarDadosSpinner() {
        ...
        String[] cidades = new String[]{
            getString(R.string.diadema),
                getString(R.string.santoAndre),
                getString(R.string.saoBernardo),
                getString(R.string.saoCaetano)
        };

        String[] categorias = new String[]{
                getString(R.string.automoveis),
                getString(R.string.imoveis),
                getString(R.string.eletronicos),
                getString(R.string.moda), getString(R.string.esportes),
                getString(R.string.musica),
                getString(R.string.infantil),
    ...
    private void salvarFotosStorage(String urlString, final int totalFotos, int contador) {
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                listaUrlFotos.add(urlCovertida);
